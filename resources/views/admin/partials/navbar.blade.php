<header class="main-header">
    ...
    " class="logo">
        ...
        <b class="logo-mini">
            <span class="light-logo"><img src="{{ asset('images/dynamic-icono.png') }}" alt="logo"></span>
            {{-- <span class="dark-logo"><img src="{{ asset('images/aries-dark.png') }}" alt="logo"></span> --}}
        </b>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">
            <img src="{{ asset('images/nombre.png') }}" alt="logo" class="light-logo">
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="my-5">Mensajes ∞ - Balance ∞</li>
                {{-- <li class="search-box">
                ...
                <ul class="dropdown-menu scale-up">
                    ...
                    <p>
                        ...
                        <a href="{{ url('/admin/profile') }}" class="btn btn-danger btn-sm btn-rounded">Ver perfil</a>
                    </p>
                    </li>
                    <!-- Menu Body -->
                    <li class="user-body">
                    <div class="row ">
                        <div class="col-12 text-left">
                            <a href="{{ url('/admin/profile') }}"><i class="ion ion-person"></i> Mi Perfil</a>
                        </div>
                        {{-- <div class="col-12 text-left">
