...
<body class="register-page-back hold-transition">        
    <div class="register-box ">
        <div class="register-logo">
            <a href="{{ route('login') }}"><b>Sms</b> Registro</a>
        </div>
        ...
        @csrf
            ...
            <div class="form-group has-feedback">
                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Confirma el password" required autocomplete="new-password">
            </div>
