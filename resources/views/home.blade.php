    ...
    <div class="content box-body">
        ...
        <div class="row">
          <div class="col-xl-4 col-md-6 col">
            ...
            <div class="info-box-content box-body">
              ...
              <span class="info-box-text"><p class="text-right"><a href="{{ URL::route('single') }}">Go to single message</a></span> 
            </div>
          <!-- /.info-box-content -->
          </div>
        <!-- /.info-box -->
          ...
          <div class="info-box">
            ...
            <div class="info-box-content box-body">
              <h3 class="box-title">Schedule a batch sendout</h3>
                ...
                <span class="info-box-text"><p class="text-right"><a href="{{ URL::route('sms') }}"class="text-left">go to batches</a></span> 
              </div>
          <!-- /.info-box-content -->
          </div>
        <!-- /.info-box -->
        ...
        <div class="col-xl-4 col-md-6 col">
          <div class="info-box">
            ...
            <div class="info-box-content box-body">
              ...
              <span class="info-box-text"><p class="text-right"><a href="{{ URL::route('tempate') }}"class="text-left">go to templete</a></span> 
            </div>
          <!-- /.info-box-content -->
          </div>
              <!-- /.info-box -->
        ...
        <div class="row ">
          ...
          <div class="col-xl-4 col-md-6 col">
            <div class="info-box">
              ...
              <div class="info-box-content box-body">
                ...
                <span class="info-box-text"><p class="text-right"><a href="{{ URL::route('contacts') }}"class="text-left">go to address book</a></span> 
              </div>
            <!-- /.info-box-content -->
            </div>
          <!-- /.info-box -->
          ...
          <div class="col-xl-4 col-md-6 col">
            ...
            <!-- /.info-box-content -->
>>>>>>> 80b2ceb3321ccd30b8f56f200df07815fe7dd6ed
            </div>
          <!-- /.info-box -->
          </div>
