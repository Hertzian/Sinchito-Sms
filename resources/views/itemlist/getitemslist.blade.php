                ...
                <tr>
                  ...
                  <td> 
                    <div class="btn-group">
                      ...
                      <form action="{{ url('/deletebatch/' . $batch->id) }}" method="post" class="">
                        @csrf
                      ...
                      {{-- Send modal --}}
                      <a href="#send-modal" class="btn btn-success" data-target="#send-modal" data-toggle="modal">Enviar SMS</a>

                      <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="send-modal" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title" id="myLargeModalLabel">Batch SMS</h4>
                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <div class="modal-body ">
              
                              <form action="{{ url('/send/' . $batch->id) }}" method="post" class="">
                                @csrf
                                <div class="form-group row">
                                  <div class="col-2"></div>
                                  <label for="recupient-input" class="col-3 col-form-label">Batch name</label>
